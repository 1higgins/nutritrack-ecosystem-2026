    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildStatCard(total, "Total", const Color.fromARGB(255, 0, 0, 0),
              ...
              _buildStatCard(
                  ...
                  "Buenos",
                  const Color.fromARGB(255, 255, 255, 255),
                  const Color.fromARGB(255, 84, 227, 44)),
              const SizedBox(width: 8),
              _buildStatCard(
                  alerta,
                  "Alerta",
                  const Color.fromARGB(255, 255, 255, 255),
                  const Color.fromARGB(255, 246, 155, 10)),
              const SizedBox(width: 8),
              _buildStatCard(
                  critico,
                  "Crítico",
                        ...
                        builder: (context) {
                          ...
                          return TextField(
                            ...
                            textAlignVertical: TextAlignVertical
                                .center, // Centrado vertical nativo del texto
                            decoration: InputDecoration(
                              hintText: isFocused ? "" : "Buscar producto...",
                              ...
                              // El padding vertical dinámico evita que el texto se desplace o se corte
                              contentPadding: const EdgeInsets.symmetric(
                                vertical: (searchHeight - 20) / 2,
                              ),
                            ),
                          );
                        },
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: (_filterUsername.isNotEmpty ||
                          ...
                          ? const Color(0xFF0059FF).withValues(alpha: 0.25)
                          : const Color.fromARGB(255, 255, 255, 255),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // SECCIÓN B: Rango de fecha (Disponible para TODOS los roles)
                const Text(
                  "FECHA DE CREACION",
                  style: TextStyle(
                      fontSize: 15,
...
//FILTRO QUE SE ENCUENTRA DEBAJO DE LA BÚSQUEDA, PERMITE FILTRAR POR ESTADO DE LOS LOTES (BUENOS, ALERTA, CRÍTICO)
  Widget _buildFilterChip({
    ...
    if (isActive) {
      switch (id) {
        case "Buenos":
          activeColor = const Color.fromARGB(255, 2, 223, 72);
          break;
        case "Alerta":
